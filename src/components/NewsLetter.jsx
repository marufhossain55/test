...
const NewsLetter = () => {
  return (
    <div>
      <SectionTitle title={'Never miss single Update'} subTitle={'Subscribe To our Newsletter now'}/>
        ...
        <div className='w-full lg:w-1/2'>
          <div className='lg:max-w-lg'>
            ...
            <p className='mt-3 text-gray-600 dark:text-gray-400'>
              be the first to knows when new{' '}
            ...
            <div className='flex flex-col mt-6 space-y-3 lg:space-y-0 lg:flex-row'>
              ...
              <button className='w-full px-5 py-2 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-green-600 rounded-lg lg:w-auto lg:mx-4 hover:bg-blue-500 focus:outline-none focus:bg-green-500'>
                Subscribe
              </button>
            </div>
          </div>
