...
export const Review = () => {
  return (
    <div>
      <SectionTitle title={'tell us what do you think'} subTitle={'Give us your personal opinion'}/>
      <div className='flex  flex-col max-w-xl p-8 shadow-sm rounded-xl lg:p-12 bg-green-200 dark:bg-gray-50 dark:text-gray-800'>
